                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            ...
                                                            <li><a href="<spring:url value="/admin/productInventory/editProduct/${product.productId}"/>" data-toggle="tooltip" data-placement="right" title="Edit"><i class="far fa-edit"></i></a></li>
